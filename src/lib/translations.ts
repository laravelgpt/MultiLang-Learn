...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "problem_solving_title": "Problem Decomposer",
    "problem_solving_desc": "Break down complex problems with AI.",
  ...
  bn: {
    ...
    // problem-solving/page.tsx
    "problem_solving_title": "সমস্যা বিভাজক",
    "problem_solving_desc": "এআই দিয়ে জটিল সমস্যাগুলি ভেঙে ফেলুন।",
  ...
  hi: {
    ...
    // problem-solving/page.tsx
    "problem_solving_title": "समस्या विघटनकर्ता",
    "problem_solving_desc": "एआई के साथ जटिल समस्याओं को तोड़ें।",
  ...
  ur: {
    ...
    // problem-solving/page.tsx
    "problem_solving_title": "مسئلہ ڈی کمپوزر",
    "problem_solving_desc": "اے آئی کے ساتھ پیچیدہ مسائل کو توڑیں۔",
