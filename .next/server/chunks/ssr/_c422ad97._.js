...
const initialLanguagesData = [
    {
        ...
        description: 'A versatile language for web development, data science, and more.',
        hint: 'python logo'
    },
    {
        id: 'js',
        name: 'JavaScript',
        icon: 'https://placehold.co/64x64.png',
        description: 'The language of the web, for building interactive front-ends.',
    ...
    },
    {
        ...
        name: 'Java',
        icon: 'https://placehold.co/64x64.png',
        description: 'A robust language for large-scale enterprise applications.',
        hint: 'java logo'
    },
    {
        id: 'cpp',
        name: 'C++',
        icon: 'https://placehold.co/64x64.png',
        description: 'High-performance programming for systems and game development.',
        hint: 'c++ logo'
    },
    {
        id: 'go',
        name: 'Go',
        icon: 'https://placehold.co/64x64.png',
        description: 'A modern language from Google for concurrent programming.',
        hint: 'go logo'
    }
];
function UserLanguagesPage() {
    ...
    const [languagesData, setLanguagesData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(initialLanguagesData);
...
//# sourceMappingURL=_c422ad97._.js.map